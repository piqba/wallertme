...
// ExportToJSON ...
func ExportToJSON(path, filename string, line interface{}) {
	_, err := os.Stat(path)
...
// ExportToRedisStream ...
func ExportToRedisStream(rdb *redis.Client, key string, value map[string]interface{}) {
...
// ExportToRedisStream ...
func ExportTokafka(p *kafka.Producer, topic string, value string) {
...
func ExportToPostgresql(db *sqlx.DB, blockID int, data string) {
	tx := db.MustBegin()
