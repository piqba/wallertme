...
# Add linker flags
linker_flags = '-s -X github.com/piqba/wallertme/cmd/cli.buildTime=${current_time} -X github.com/piqba/wallertme/cmd/cli.versionHash=${git_hash} -X github.com/piqba/wallertme/cmd/cli.version=${version}'
